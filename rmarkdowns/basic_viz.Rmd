...
###It seems like the darkest blue points (countries with the lowest SDG 10 scores) tend to have mid-range or low SDG 8 / SDG 9 scores as well. The lightest blue points (countries with the highest SDG 10 scores) tend to have high SDG 8 / SDG 9 scores as well. However, there are several countries that do not follow this trend.
...
```
```{r}
ggplot(sdr_data, aes(x = goal_12_score, fill=regions_used_for_the_sdr)) + 
  geom_histogram(bins=33, color="black")
```

Interpretation:
Countries that fall in the higher end of the Goal 12 spectrum belong to the countries in Sub-Saharan Africa, while the OECD region countries lie towards the lower end. 